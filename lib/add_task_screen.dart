...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  _handleDatePicker() async {
    final date = await showDatePicker(context: context, initialDate: _date, firstDate: DateTime(2020), lastDate: DateTime(2050));
  ...
  _handleTimePicker() async {
    final timePicked = await showTimePicker(context: context, initialTime: _selectedTime);
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(labelText: 'Date', labelStyle: TextStyle(color: Colors.black)),
                      ),
                      TextFormField(
                        readOnly: true,
                        controller: _timeController,
                        onTap: _handleTimePicker,
                        decoration: InputDecoration(labelText: 'Time', labelStyle: TextStyle(color: Colors.black)),
                      ),
